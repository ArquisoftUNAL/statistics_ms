...
async def startup():
    ...
    await init_beanie(database=app.state.client[STATISTICS_DB], document_models=[ReportDocument])
    app.state.rabbitmq_client = RabbitMQClient(RABBITMQ_HOST, RABBITMQ_QUEUE, RABBITMQ_USERNAME, RABBITMQ_PASSWORD)
